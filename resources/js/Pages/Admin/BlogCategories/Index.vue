    ...
    <div class="card">
        ...
        <DataTable :paginator="true"
            ...
            <Column header="Delete">
                <template #body="slotProps">
                    <Button
                        @click="deleteBlogCategory($event,slotProps.data.id)"
                        label="Delete"
                        v-tooltip.top="'Delete Blog Category'"
...
const deleteBlogCategory = (event, id) => {
    confirm.require({
        target: event.currentTarget,
        message: "Do you want to delete this blog category?",
        icon: "pi pi-info-circle",
        acceptClass: "p-button-danger",
        accept: () => {
            Inertia.delete(route("admin.blog-category.destroy", id));
        },
        reject: () => {
            toast.add({
                severity: "info",
