<template>
    <Head>
        ...
        <meta name="description" content="Product Category List">
    </Head>
    ...
    <div class="card">
        ...
        <DataTable :paginator="true"
                   ...
                   filterDisplay="menu"
                   :globalFilterFields="['name','description','product.name']"
                   :value="cats"
            ...
            <Column field="name" header="Name" :sortable="true">
                <template #body="slotProps">
                    <Link
                        ...
                        :href="$route('admin.product-category.edit',slotProps.data.id)">
                        {{ slotProps.data.name }}
                    </Link>
                </template>
            </Column>
            ...
            <Column header="Delete">
                <template #body="slotProps">
                    <Button
                        @click="deleteProductCategory($event,slotProps.data.id)"
                        label="Delete"
                        v-tooltip.top="'Delete Product Category'"
...
const deleteProductCategory = (event, id) => {
    confirm.require({
        ...
        accept: () => {
            Inertia.delete(route("admin.product-category.destroy", id));
        },
        reject: () => {
            toast.add({
                severity: "info",
