<x-layouts.app>
    <x-slot:title>
        Viewing Bounty: {{ $bounty->item_name }}
    </x-slot:title>
    <main class="main">
                                            ...
                                            <div class="row justify-content-center mb-10">
                                                ...
                                                <p class="text-center">
                                                    <button class="btn btn-primary btn-sm" type="button"
                                                            data-bs-toggle="collapse" data-bs-target="#adminFunctions"
                                                            aria-expanded="false" aria-controls="adminFunctions">
                                                        Admin Functions
                                                    </button>
                                                    <button class="btn btn-primary btn-sm" type="button"
                                                ...
                                                <div class="collapse" id="adminFunctions">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                    @foreach ($bounty->reports as $report)
                                                                        <tr>
                                                                            <td>{{ $report->id }}</td>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            ...
                                            <span>
                                                    ...
                                                    <span
                                                        class="old-price font-md ml-15">Old Price</span>
                                                </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-extralink mb-50">
                                        ...
                                        <div class="product-extra-link2">
                                            ...
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                               href="{{ route('watchlist.store', $bounty->product_id) }}"><i
                                    ...
                                    <div class="font-xs">
                                        <ul class="mr-50 float-start">
                                            <li class="mb-5">Posted By: <span class="text-brand"><a
                                                        href="#">{{ $bounty->user->displayName() }}</a></span></li>
                                            <li class="mb-5">Posted:<span
                                                    class="text-brand"> {{ $bounty->createdAt() }}</span></li>
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="audit">
                                        ...
                                        <div class="accordion" id="kt_accordion_1">
                                            @foreach ($bounty->audits as $audit)
                                    ...
                                    <div class="tab-pane fade" id="Comments">
                                        ...
                                        <div class="comment-form">
                                            ...
                                            @include('frontend.partials.bounty-comment-form')
                                        </div>
                                    </div>
                                </div>
                            </div>
