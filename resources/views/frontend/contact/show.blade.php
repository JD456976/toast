                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    <div class="contact-from-area padding-20-row-col">
                                        ...
                                        {!! Form::open(['route' => 'contact.store', 'method' => 'post', 'class' => 'contact-form-style mt-30', 'id' => 'contact-form']) !!}
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="input-style mb-20">
                                                        {!! Form::text('phone', old('phone'), ['placeholder' => 'Your Phone Number']) !!}
                                                        @error('phone')
                                                        <x-admin.alert type="danger" :message="$message" />
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="input-style mb-20">
                                                        {!! Form::select('subject', ['advertising' => 'Advertising', 'account' => 'Account Help', 'other' => 'Other'], '', ['class' => 'form-control select-active']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="textarea-style mb-30">
                                                        {!! Form::textarea('message', old('message'), ['placeholder' => 'Your Message', 'style' => 'height:150px;']) !!}
                                                        @error('message')
                                                        <x-admin.alert type="danger" :message="$message" />
                                                        @enderror
                                                    </div>
                                                    {!! Form::submit('Send Message', ['class' => 'submit submit-auto-width']) !!}
                                                </div>
                                            </div>
                                            {!! Form::close() !!}
