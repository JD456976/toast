                                            ...
                                            <div class="row justify-content-center mb-10">
                                                <div class="col">
                                                    ...
                                                    <a href="{{ route('admin.deal.edit', $deal->id) }}"><button class="btn btn-sm">Edit Deal</button></a>
                                                        ...
                                                        @endif
                                                        @if ($deal->is_active == 1)
                                                            <a href="{{ route('deal.unapprove', $deal->id) }}"><button class="btn btn-sm">Unapprove Deal</button></a>
                                                        @else
                                                            <a href="{{ route('deal.approve', $deal->id) }}"><button class="btn btn-sm">Approve Deal</button></a>
                                                        @endif
