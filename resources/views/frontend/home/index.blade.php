    ...
    <main class="main">
        <div class="container mb-30">
            <div class="row">
                                            ...
                                            <div class="product-cart-wrap mb-30">
                                                <div class="product-img-action-wrap">
                                                    ...
                                                    <div class="product-action-1">
                                                        <a aria-label="Add To Wishlist" class="action-btn"
                                                           href="{{ route('watchlist.store', $deal->product->id) }}"><i
                                                ...
                                                <div class="product-content-wrap">
                                                    <div class="product-category">
                                                        <a href="shop-grid-right.html">{{ $deal->product->name }}</a>
                                                    </div>
                                                    <h2>
                                                    ...
                                                    <div class="product-card-bottom">
                                                        <div class="product-price">
                                                            <span>{{ $deal->dealDiscount() }}</span>
                                                            <span class="old-price">{{ $deal->dealPrice() }}</span>
                                                        </div>
                                                        <div class="add-cart">
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href="shop-product-right.html">Blue Diamond Almonds Lightly</a>
                                                </h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                ...
                @include('frontend.partials.home-widgets.categories')
                <!-- Fillter By Price -->
                @include('frontend.partials.home-widgets.filter')
                <!-- Product sidebar Widget -->
                    @include('frontend.partials.home-widgets.new')
                </div>
            </div>
        </div>
