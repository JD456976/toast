                ...
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="mb-50">
                        ...
                        <h6 class="text-body">There are <span
                                class="text-brand">{{ $currentUser->watchlistCount() }} </span> products in your list
                        </h6>
                    </div>
                    <div class="row">
                        <div class="col mb-5">
                                ...
                                @foreach ($active as $item)
                                    <tr class="pt-30">
                                        ...
                                        <td class="text-right" data-title="Deactivate">
                                            <button class="btn" wire:click="deactivate({{ $item->id }})">Deactivate
                                            </button>
                                        </td>
                                        <td class="text-center">
                                            <button class="btn" wire:click="deleteConfirm({{ $item->id }})">Delete
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach ($inactive as $item)
                                    <tr class="pt-30">
                                        ...
                                        <td class="text-right" data-title="Actviate">
                                            <button class="btn" wire:click="activate({{ $item->id }})">Activate</button>
                                        </td>
